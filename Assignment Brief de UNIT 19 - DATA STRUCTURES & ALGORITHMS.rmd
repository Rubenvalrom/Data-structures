...
**Paso 1: Comenzar en la raíz**

-   Comienza buscando el elemento en la raíz del árbol.

**Paso 2: Comparar el valor del nodo actual con el elemento a buscar**

-   Si el valor del nodo actual es igual al elemento a buscar, has encontrado el elemento y puedes detener la búsqueda.
-   Si el valor del nodo actual es mayor que el elemento a buscar, sigue hacia la izquierda (hacia el hijo izquierdo).
-   Si el valor del nodo actual es menor que el elemento a buscar, sigue hacia la derecha (hacia el hijo derecho).

**Paso 3: Repetir los pasos 1 y 2 hasta encontrar el elemento o llegar a una hoja**

-   Sigue comparando el valor del nodo actual con el elemento a buscar y moviéndote hacia la izquierda o derecha según sea necesario.
-   Si llegas a una hoja (un nodo sin hijos), significa que el elemento no está en el árbol.

**Paso 4: Devolver el resultado**

-   Si encontraste el elemento, devuelve su valor.
-   Si no encontraste el elemento y llegaste a una hoja, devuelve un mensaje indicando que el elemento no se encuentra en el árbol.

**Ejemplo:**

Supongamos que tenemos un montículo de Fibonacci con los nodos 5, 3, 7 y 2 en ese orden y queremos buscar el elemento 7.

1.  **Comenzar en la raíz:** El valor del nodo actual es 5.
2.  **Comparar el valor del nodo actual con el elemento a buscar**: 5 \> 7 (no), así que sigue hacia la izquierda.
3.  **Repetir los pasos 1 y 2:** El valor del nodo actual es 3, pero 3 \< 7, así que sigue hacia la derecha.
4.  **Repetir los pasos 1 y 2:** El valor del nodo actual es 7, busqueda finalizada.

**Resultado final:**

-   Devuelve el valor del elemento encontrado (en este caso, 7).

En resumen, la búsqueda de un elemento en un montículo de Fibonacci implica comparar el valor del nodo actual con el elemento a buscar y moviéndote hacia la izquierda o derecha según sea necesario. Si llegas a una hoja, significa que el elemento no está en el árbol.
...
**Referencias** - shortest_path — SciPy v1.14.1 Manual (no date). <https://docs.scipy.org/doc/scipy/reference/generated/scipy.sparse.csgraph.shortest_path.html#scipy.sparse.csgraph.shortest_path>.
