...
-   Creamos un conjunto de nodos visitados vacío (`V = ∅`).
...
-   El nodo con la distancia más pequeña desde el nodo **A** es el nodo **B**, que tiene una distancia de 2.
-   Agregamos el nodo **B** al conjunto de nodos visitados (`V = {B}`).

**Paso 3: Actualización de distancias**

-   La distancia del nodo **C** desde el nodo **A** es la suma de la distancia del nodo **B** a sí mismo y la distancia del nodo **B** al nodo **C**, que es ∞ + ∞ = ∞.
...
-   La distancia del nodo **E** desde el nodo **A** es la suma de la distancia del nodo **B** a sí mismo y la distancia del nodo **B** al nodo **E**, que es ∞, ya que no hay arista entre los nodos **B** y **E**.
...
-   La distancia del nodo **E** desde el nodo **A** es la suma de la distancia del nodo **B** a sí mismo y la distancia del nodo **B** al nodo **E**, que es 2 + ∞ = ∞.
...
-   El nodo con la distancia más pequeña desde el nodo **A** es el nodo **C**, que tiene una distancia de 2.
-   Agregamos el nodo **C** al conjunto de nodos visitados (`V = {B, C}`).

La ruta más corta del Nodo **A** al **C** con el Algoritmo Dijkstra es:

1.  A → B
2.  B → D
3.  D → C

La distancia total es 2 + 3 = 5.
...
```{python}
pred, dist = nx.dijkstra_predecessor_and_distance(G,'C',weight = d['peso'])
print(pred)
print(dist)
```
...
La complejidad temporal total del Algoritmo de Dijkstra con Montículo de Fibonacci es:

$O(V \log V + E)$

donde $V$ es el número de vértices (nodos) en el grafo y $E$ es el número de aristas (edades) en el grafo.
