...
```{python}
# Defino la matriz de adyacenncia utilizada en el ejemplo
matriz = [ 
[0, 2, 0, 0, 5], 
[2, 0, 0, 3, 0], 
[0, 0, 0, 2, 4], 
...
```{python}
print("Camino más corto: ",nx.shortest_path(G, source='A', target='C', weight='peso', method='dijkstra'))

print("Distancia: ",nx.shortest_path_length(G, source='A', target='C', weight='peso', method='dijkstra'))
