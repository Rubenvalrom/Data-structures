...
-   La distancia del nodo E desde el nodo A sigue siendo infinita, ya que no hay arista directa entre los nodos B y E.
...
-   El nodo con la distancia más pequeña desde el nodo A sigue siendo el nodo B, con una distancia de 2.
-   Agregamos el nodo B al conjunto de nodos visitados (V = {B}).
...
-   La distancia del nodo E desde el nodo A sigue siendo infinita.
...
```{python}
nx.shortest_path(G, source='A', target='C', weight='peso', method='dijkstra')
nx.shortest_path_length(G, source='A', target='C', weight='peso', method='dijkstra')
